import type { State, Getters, ModuleOptions, PublicStore, GlobalStore, GlobalDebugInfo, UseStore } from './types';
declare class GlobalStoreImpl implements GlobalStore {
    private registry;
    private storeFactories;
    private publicAPICache;
    register<S extends State, G extends Getters<S>, A extends object>(options: ModuleOptions<S, G, A>): UseStore<S, G, A>;
...
export declare function defineStore<S extends State, G extends Getters<S>, A extends object>(options: ModuleOptions<S, G, A>): UseStore<S, G, A>;
